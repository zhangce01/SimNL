...
imagenet_templates = [
    ...
    "An image of a {} with bright and natural lighting."
    ]

imagenet_negative_templates = [
    "itap without any {}.",
    "a bad photo with no {} in it.",
    "a origami piece that isn't a {}.",
    "a photo with no large {}.",
    "a video game scene without a {}.",
    "art that doesn't include a {}.",
    "a photo with no small {}.",
    "A landscape devoid of any {}.",
    "An image completely lacking a {}.",
    "A scene with no trace of {}.",
    "An empty space without any {}.",
    "A picture where {} is conspicuously absent.",
    "A setting that is free from any {}.",
    "A photo without a single {} in sight."
    ]
...
class ImageNet_N():
    ...
    def __init__(self, root, num_shots, preprocess):
        ...
        self.negative_template = imagenet_negative_templates
        self.classnames = imagenet_classes
        self.cupl_path = './gpt3_prompts/CuPL_prompts_imagenet.json'
        self.gpt4_path = './gpt4_prompts/imagenet.json'
    ...
    def __len__(self):
        return len(self.train.imgs)
    
    def __getitem__(self, idx):
        img = self.train[idx][0]
